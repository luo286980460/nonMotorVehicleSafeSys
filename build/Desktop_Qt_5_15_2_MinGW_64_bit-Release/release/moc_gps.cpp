...
QT_MOC_LITERAL(1, 4, 7), // "showMsg"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 3), // "msg"
QT_MOC_LITERAL(4, 17, 14) // "slotUnPackData"

    },
    "GPS\0showMsg\0\0msg\0slotUnPackData"
};
...
void GPS::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotUnPackData(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GPS::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GPS::showMsg)) {
                *result = 0;
                return;
            }
        }
